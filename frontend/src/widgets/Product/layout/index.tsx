...
export const ProductLayout: FC<Props> = ({
  ...
  return (
    <div className="bg-[#FBFCFF] border-main-light-blue border-[1px] rounded-2xl flex justify-between px-4 py-4 items-center">
      ...
      <div className="flex items-center gap-x-3">
        <Button disabled border className="bg-main-white !text-main-dark-blue">
          {price} руб
        </Button>
        <Button disabled border className="bg-main-white !text-main-dark-blue">
          {quantity} шт.
